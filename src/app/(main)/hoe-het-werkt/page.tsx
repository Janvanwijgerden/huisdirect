    ...
    <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-12 rounded-2xl border border-stone-200 bg-white p-6">
        <h2 className="text-xl font-semibold text-stone-900">
          Klaar om zelf je woning te verkopen?
        </h2>

        <p className="mt-3 text-stone-600">
          Ontdek hoe je met HuisDirect de controle houdt, kosten bespaart en je
          woning professioneel presenteert.
        </p>

        <div className="mt-5">
          <Link
            href="/voor-verkopers"
            className="inline-flex items-center justify-center rounded-xl border border-stone-300 bg-white px-5 py-2.5 text-sm font-semibold text-stone-800 transition hover:bg-stone-50"
          >
            Bekijk voor verkopers
          </Link>
        </div>
      </div>
